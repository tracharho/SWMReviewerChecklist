...
class Project(db.Model):
    ...
    rma_present = db.Column(db.Boolean, default = False, nullable = True)
    rpa_present = db.Column(db.Boolean, default = False, nullable = True)
    wmp_present = db.Column(db.Boolean, default = False, nullable = True)
    wetlands_present = db.Column(db.Boolean, default = False, nullable = True)
